...
#### Scenario: Resumen accionable de continuidad
- **WHEN** el usuario abre `/pacientes/[id]?mode=view`
- **THEN** el sistema muestra una seccion de continuidad actual
- **AND** resume la ultima consulta con fecha, motivo, diagnostico y tratamiento cuando existan
- **AND** resume la ultima receta con medicamentos e indicaciones cuando exista
- **AND** muestra una accion sugerida para continuar la atencion
