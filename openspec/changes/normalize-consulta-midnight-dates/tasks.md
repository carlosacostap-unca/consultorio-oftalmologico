## 1. Script de migracion

- [x] 1.1 Crear script administrativo con dry-run, apply protegido, backup y reporte.
- [x] 1.2 Ejecutar dry-run contra PocketBase y validar conteo/muestras.
