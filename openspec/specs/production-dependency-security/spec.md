...
## Purpose
Definir los controles de seguridad, reproducibilidad y compatibilidad que debe superar una actualización de dependencias antes de publicar el runtime web o el instalador de escritorio.
