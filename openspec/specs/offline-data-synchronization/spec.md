...
El sistema SHALL mostrar conectividad, última sincronización, cantidad de pendientes, errores y conflictos, y SHALL permitir iniciar una sincronización manual no concurrente.
...
- **WHEN** una operación falla por red, autenticación, validación o conflicto
- **THEN** la pantalla clasifica el error y conserva la operación
