# desktop-update-distribution Specification

## Purpose
Define la publicación, distribución privada, promoción por canales e instalación segura de actualizaciones para la aplicación de escritorio.
## Requirements
