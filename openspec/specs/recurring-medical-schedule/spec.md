# Recurring Medical Schedule Specification

## Purpose
Define la configuracion de agendas semanales recurrentes, bloqueos y generacion de horarios disponibles para los medicos del consultorio.
