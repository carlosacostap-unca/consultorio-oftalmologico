# Duplicate Ficha Review Specification

## Purpose
Define la revision administrativa y la correccion controlada de fichas clinicas asignadas a multiples pacientes activos.
